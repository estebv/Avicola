...
@mortalidad_blueprint.route('/api/mortalidad', methods=['POST'])
def add_mortalidad():
...
@mortalidad_blueprint.route('/mortalidad/<int:id>', methods=['PUT'])
...
@mortalidad_blueprint.route('/mortalidad/<int:id>', methods=['DELETE'])
